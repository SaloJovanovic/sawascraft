...
const Nations = ({navbarLightMode}) => {
  ...
  const[nations, setNations] = useState([
    ...
    new nation("The Republic of Soldium", "skyrex", soldiumFlag, "Republic", "Originally a merchant outpost, the Republic of Soldium quickly grew to a size of a city. Thus it's no wonder that merchant values translate into the way of governance. Therefor Team work, organization and respect of the contract and merchant law are the core values we stand on. To our republic everyone with a will to work and grow is invited."),
    new nation("Regnum Aeternum", "unknown", regnumAeternumFlag, "Monarchy", "Regnum Aeternum/Eternal Kingdom once strong empire that united all people of Omnia faced its collapse during rule of Mad King and his inbred family. People rebelled against and him, and once Kingdom that saved world from eternal darkness was corrupted by it. Rebellion some provoked by evil spirits and some trying to save people from mad king led to final collapse of Empire. King’s closest advisors poisoned and him and placed Adeodatus I long lost cousin of Mad King.  Will Adeodatus be able to fight against darkness and establish peace and prosperity in Omnia, or is it already too late. What we can do is pray to the 4 Gods of Omnia to give us power to fight."),
    new nation("Jundullah Caliphate", "bjkai", jundullahCaliphateFlag, "Monarchy", "\n" +
      "We are the Jundullah Caliphate. We rose up from the ashes of a failed state, and emerged as an irreplaceable force, one that notifies everyone of its presence. We fight for what we think is right, we fight the ones who have dared to oppose us. This world has no place for non believers, and it is evident. We will do what we see fit, and we must cleanse this world from its filth. Glory to the Jundullah Caliphate."),
